...
const sectionGroupings = [
  ...
  ['how-do-i-fellowship-with-the-spirit', 'how-do-i-meet-messiah']
];

// Book metadata
const bookMetadata = {
  en: {
    title: 'Encountering Messiah: A Journey for Jewish Hearts',
    subtitle: 'A Journey for Jewish Hearts',
    author: 'Humbleberger Ministries',
    description: 'An eBook Bringing the Gospel of Yeshua the Messiah to the Jewish People',
