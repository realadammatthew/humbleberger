          ...
          <div className='encountering-messiah-content'>
            ...
            <div className='section'>
              ...
              <ul>
                ...
                <li>
                  <a href={t('urls.encountering.whySomeJewsReject')}>
                    {t('encountering.section5.whySomeReject')}
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div className='section'>
              ...
              <ul>
                <li>
                  <a href={t('urls.encountering.whatAboutThe613Mitzvot')}>
                    {t('encountering.section6.all613Mitzvot')}
                  </a>
                </li>
                <li>
                  <a href={t('urls.encountering.whatAboutTheKosherLaws')}>
                    {t('encountering.section6.keepKosher')}
                  </a>
                </li>
                <li>
                  <a href={t('urls.encountering.whatAboutShabbat')}>
                    {t('encountering.section6.keepShabbat')}
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div className='section'>
              ...
              <ul>
              <li>
                  <a href={t('urls.encountering.howDoIFellowshipWithTheSpiritual')}>
