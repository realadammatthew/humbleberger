          ...
          <div className='encountering-messiah-content'>
            ...
            <div className='section'>
              ...
              <ul>
                ...
                <li>
                  <em>{t('encountering.section4.sacrificeRole')}</em>{' '}
                  <span className='coming-soon'>
                    {t('encountering.comingSoon')}
                  </span>
                </li>
                <li>
                  <em>{t('encountering.section4.atonementWithoutTemple')}</em>{' '}
                  <span className='coming-soon'>
                    {t('encountering.comingSoon')}
                  </span>
                </li>
                <li>
                  <em>{t('encountering.section4.rightRelationship')}</em>{' '}
                  <span className='coming-soon'>
                    {t('encountering.comingSoon')}
                  </span>
                </li>
                ...
                <li>
                  <em>{t('encountering.section4.goToHeaven')}</em>{' '}
                  <span className='coming-soon'>
                    {t('encountering.comingSoon')}
                  </span>
                </li>
                <li>
                  <em>{t('encountering.section4.hellExists')}</em>{' '}
                  <span className='coming-soon'>
                    {t('encountering.comingSoon')}
                  </span>
                </li>
            ...
            <div className='section'>
              ...
              <ul>
                <li>
                  <em>{t('encountering.section5.jewishAndBelieve')}</em>{' '}
                  <span className='coming-soon'>
                    {t('encountering.comingSoon')}
                  </span>
                </li>
                <li>
                  <em>{t('encountering.section5.whySomeBelieve')}</em>{' '}
                  <span className='coming-soon'>
                    {t('encountering.comingSoon')}
                  </span>
                </li>
