      ...
      <section>
        ...
        <div className='toc-list'>
          {displayedPosts.map((post) => (
            <Link
              href={isHebrew ? `/he/blog/${post.slug}` : `/blog/${post.slug}`}
              key={post.slug}
              legacyBehavior
            >
