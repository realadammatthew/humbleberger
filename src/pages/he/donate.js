      ...
      <main style={{ direction: 'rtl', textAlign: 'right', padding: '0' }}>
        ...
        <section style={{ padding: '1.5rem 1rem', margin: '1rem 0' }}>
          ...
          >
            ...
            >
              <iframe
                src="https://donorbox.org/embed/humbleberger-ministries-he?default_interval=m&amount=300&show_content=true"
                name="donorbox"
...
export default withBanner(HebrewDonatePage);
