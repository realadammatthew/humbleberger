  ...
  en: {
    translation: {
      ...
      'ourStory.content':
        ...
        '<p class="clear-float">In 2020, just before the onset of COVID-19, Adam placed his faith in Yeshua the Jewish Messiah. In 2023, he relocated to Greenville, South Carolina, to pursue greater ministry opportunities.</p>' +
  ...
  he: {
    translation: {
      ...
      'ourStory.content':
        ...
        '<p class="clear-float">בשנת 2020, רגע לפני התפרצות מגפת הקורונה, אדם הפגין אמונה בישוע המשיח היהודי. בשנת 2023, הוא עבר לגרינוויל, דרום קרוליינה, כדי לחפש הזדמנויות משרד גדולות יותר.</p>' +
